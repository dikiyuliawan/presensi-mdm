...
const formatDataForExcel = (rawData) =>
  rawData.map((data) => ({
    ...
    presenceDate: new Date(data.clock_in.seconds * 1000).toLocaleDateString(),
    clock_in: new Date(data.clock_in.seconds * 1000).toLocaleTimeString(),
    clock_out: new Date(data.clock_out.seconds * 1000).toLocaleTimeString(),
